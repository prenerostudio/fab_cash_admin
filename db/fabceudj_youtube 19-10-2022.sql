...
INSERT INTO `active_packages` (`active_id`, `u_id`, `package_id`, `package_name`, `active_date`) VALUES
(1, 33, 3, 'name', '0000-00-00'),
(2, 33, 2, 'Mantle', '2022-10-18'),
(3, 33, 6, 'Asthenosphere ', '2022-10-18');
...
(145, '03027750114', '1', 'Tom und Jerry auf Deutschhh', 'https://www.youtube.com/watch?v=64DUWAFw6uM', 2, 'unseen', '2022-10-19'),
(146, '03027750114', '3', 'MySQL Introduction Tutorial in Hindi / Urdu', 'https://www.youtube.com/watch?v=KlWOr2RwqM4', 2, 'unseen', '2022-10-19'),
(147, '03027750114', '4', 'MySQL Create Table Tutorial in Hindi / Urdu', 'https://www.youtube.com/watch?v=tN3B0F24fJs', 2, 'unseen', '2022-10-19'),
...
(150, '03027750114', '7', 'CSS Media Queries Tutorial in Hindi / Urdu', 'https://www.youtube.com/watch?v=vBOMyYP9BDU', 2, 'unseen', '2022-10-19'),
...
--
ALTER TABLE `spin_wheel`
  MODIFY `spin_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `watch_videos`
  MODIFY `wv_id` int(40) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=152;
COMMIT;
